...
const cards = [
  ...
  },
  {
    ...
    description:
      "All 54 tools carry readOnlyHint, destructiveHint, and idempotentHint annotations so your LLM inherently understands the weight of each action.",
  },
];
      ...
      <div className="mx-auto max-w-7xl px-6">
        ...
        >
          ...
          <p className="mx-auto mt-4 max-w-2xl text-lg text-muted">
            Safety is a first-class citizen. Your simulations are protected by
            default.
          </p>
        </motion.div>
        ...
        <div className="mt-16 grid gap-6 md:grid-cols-3">
          {cards.map((c, i) => (
            <motion.div
              ...
              className="rounded-2xl border border-border bg-panel p-8 transition-all hover:border-accent/40 hover:shadow-lg hover:shadow-accent/5"
            >
